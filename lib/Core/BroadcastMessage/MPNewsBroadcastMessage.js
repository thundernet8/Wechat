...
var MPNewsBroadcastMessage = /** @class */ (function (_super) {
    __extends(MPNewsBroadcastMessage, _super);
    /**
     * @param mediaId
     * @param ignoreReprint 图文消息被判定为转载时，是否继续群发。 1为继续群发（转载），0为停止群发。 该参数默认为0
     */
    function MPNewsBroadcastMessage(mediaId, ignoreReprint) {
    ...
    MPNewsBroadcastMessage.prototype.toPOJO = function () {
    ...
    return MPNewsBroadcastMessage;
}(BroadcastMessage_1.default));
exports.default = MPNewsBroadcastMessage;
