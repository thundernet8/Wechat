...
var AccessToken_1 = require("../../OfficialAccount/Auth/AccessToken");
/**
 * JSSDK Service Provider
 */
var ServiceProvider = /** @class */ (function (_super) {
    ...
    ServiceProvider.prototype.register = function (app) {
        ...
        app.setService("jssdk", new ServiceClient_1.default(app, new AccessToken_1.default(app)));
        return this;
    };
