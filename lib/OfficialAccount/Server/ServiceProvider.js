...
var ServiceProvider = /** @class */ (function () {
    ...
    Object.defineProperty(ServiceProvider.prototype, "middleware", {
        /**
         * Middleware for koa/express
         */
        get: function () {
            return Middleware_1.default(this.app, this);
        },
        enumerable: true,
        configurable: true
    });
    ServiceProvider.prototype.response = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, body, originMsg, respMsg, i, handler, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        originMsg = MessageHelper_1.default.fromXML(this.app.request.body.xml);
                        i = 0;
                        _a.label = 1;
                    case 1:
                    ...
                    case 4:
                        if (respMsg) {
                            if (resp instanceof Message_1.default) {
                                resp.body = resp.toXML();
                            }
                            else {
                                resp.body = new TextMessage_1.default("", originMsg.to, originMsg.from, respMsg, Math.ceil(moment.now().valueOf() / 1000)).toXML();
                            }
                        }
                        else {
                            resp.body = "";
    ...
    ServiceProvider.prototype.handle = function (handler) {
