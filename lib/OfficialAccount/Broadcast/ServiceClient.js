...
var MPNewsBroadcastMessage_1 = require("Core/BroadcastMessage/MPNewsBroadcastMessage");
/**
...
var ServiceClient = /** @class */ (function (_super) {
     ...
     * @param msgId
     */
    ServiceClient.prototype.status = function (msgId) {
        var data = {
            msg_id: msgId
        };
    ...
    ServiceClient.prototype.sendNews = function (mediaId, reception) {
        var message = new MPNewsBroadcastMessage_1.default(mediaId);
        return this.sendMessage(message, reception);
    };
