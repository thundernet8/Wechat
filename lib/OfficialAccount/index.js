...
var ServiceProvider_3 = require("../BasicService/Media/ServiceProvider");
var Application = /** @class */ (function (_super) {
    __extends(Application, _super);
    function Application(config) {
        var _this = _super.call(this, config) || this;
        _this.providers = [ServiceProvider_1.default, ServiceProvider_2.default, ServiceProvider_3.default];
        _this.initServices();
        return _this;
    }
    return Application;
